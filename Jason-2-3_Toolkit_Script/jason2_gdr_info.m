...
function jason_gdr_info( In_Pass, lat_range, File_Suffix_name )
...
filename1 = strcat(outfolder,'/j2_gdr_p', In_Pass, '_',File_Suffix_name,'_info.txt');
