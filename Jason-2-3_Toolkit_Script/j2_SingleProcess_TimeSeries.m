...
[FileName, PathName, ext] =uigetfile({'*.txt';'*.mat'});
...
Hgt_Datum=FinalSeries(:,5)-N-0.7; % Reduced to WG84 
...
Plot_title= strcat(WaterInfo{1}, ', Jason-2 GDR Pass-', FileName(9:11),'  Lon=%6.3f Lat=%6.3f');
